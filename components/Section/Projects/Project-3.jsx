...
const Project1 = () => {
    const projectImgList = [
        { id: 1, src: '/images/chatapp/1.png', alt: 'Desktop View', bg: 'bg-gradient-to-tr from-white via-rose-600/30 to-stone-600/40', class: 'rounded-xl md:rounded-2xl w-full h-full' },
        { id: 2, src: '/images/chatapp/2.png', alt: 'Responsive Mobile View', bg: 'bg-gradient-to-tr from-white via-rose-600/30 to-stone-600/40', class: 'rounded-xl md:rounded-2xl w-full h-full' },
        { id: 3, src: '/images/chatapp/3.png', alt: 'User Lists from Mobile', bg: 'bg-gradient-to-r from-zinc-500 to-stone-700', class: 'rounded-xl md:rounded-2xl w-full h-full' },
        { id: 4, src: '/images/chatapp/4.png', alt: 'Responsive Mobile View', bg: 'bg-gradient-to-tr from-teal-600/10 via-rose-600/40 to-green-600/20', class: 'rounded-xl md:rounded-2xl w-full h-full' },
    ]
